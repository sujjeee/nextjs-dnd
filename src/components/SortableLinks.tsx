        ...
        <div ref={setNodeRef} style={style} key={uniqueId}>
            <Card className='p-4 relative flex justify-between gap-5 group' >
                ...
                <div className='flex justify-center items-center gap-4'>
                    <button className="hidden group-hover:block " onClick={() => handleButtonClick(uniqueId)}>
                    ...
                    <button className="bg-white" {...attributes} {...listeners} aria-describedby={`DndContext-${uniqueId}`} >
